...
class AppColors {
  ...
  static const List<Color> alphabetGradient = [
    Color(0xFF00C853),
    Color(0xFF69F0AE),
  ];
  static const List<Color> numberGradient = [
    Color(0xFFFF6D00),
    Color(0xFFFFAB40),
  ];
  static const List<Color> shapeGradient = [
    Color(0xFF2979FF),
    Color(0xFF82B1FF),
  ];
  static const List<Color> fruitsGradient = [
    Color(0xFFFF1744),
    Color(0xFFFF8A80),
  ];
  static const List<Color> practiceGradient = [
    Color(0xFFAA00FF),
    Color(0xFFEA80FC),
  ];
  ...
  static const List<Color> birdsGradient = [
    Color(0xFF00E5FF),
    Color(0xFF18FFFF),
  ];
