...
class WildAnimalsScreen extends ConsumerWidget {
  const WildAnimalsScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: const TapPicoAppBar(
        title: 'Wild Animals',
        gradientColors: AppColors.wildGradient,
      ),
      body: Stack(
        children: [
          SafeArea(
            ...
            child: Column(
              children: [
                ...
                const InfoHeader(label: 'Explore the wild! 🌿'),
                Expanded(
