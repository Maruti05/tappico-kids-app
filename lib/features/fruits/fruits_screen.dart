          ...
          SafeArea(
            ...
            child: Column(
              children: [
                ...
                const InfoHeader(label: 'Learn your fruits! 🍎'),
                Expanded(
          ...
          if (tapped != null)
            TapOverlay(
              color: AppColors.letterColors[
                fruitData.indexWhere((e) => e.name == tapped.name) %
                AppColors.letterColors.length
              ],
              onDismiss: () => ref.read(_tappedFruitProvider.notifier).set(null),
              child: Column(
